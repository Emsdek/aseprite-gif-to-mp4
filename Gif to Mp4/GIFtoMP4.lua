...
local function showHelp()
    ...
    if app.fs.isFile(leemePath) then
        ...
        showAlert("Ayuda", "No se encontró leeme.txt en:\n" .. leemePath)
    end
end
...
local function main()
    if not sprite then
        showAlert("Error", "No hay ningún sprite abierto.\nAbre un archivo de Aseprite primero.")
        return
    end
    ...
    dlg:button{
        ...
        onclick=function()
            ...
            showAlert("Información","Convirtiendo a MP4...\nEsto puede tomar unos momentos.")
            ...
            if success then
                ...
                showAlert("Error", "La conversión falló ❌\nRevisa los archivos en la carpeta TEMP.")
            end
        end
    }
